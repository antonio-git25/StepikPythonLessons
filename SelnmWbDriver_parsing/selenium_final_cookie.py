...
for cook in cookies:
    ...
    with webdriver.Chrome() as browser:
        ...
        temp_dict = {'name_value': cook['value'], 'age': int(age.split(':')[1]), 'skills': int(len(skill_list))}
...
sorted_result_list = sorted(result_list, key=lambda res: res['age'])
print('\n Sorted Pre-Final results:')
for res in sorted_result_list:
    print(res)
